import torch
from quant.quantization import quan_Conv2d, quan_Linear  
...
def bin2int(input, num_bits):
    ...
    with the bitwise operations.Note that, in order to perform the bitwise operation,
    the input tensor has to be in the integer format.
