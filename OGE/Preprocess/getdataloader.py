...
DIR = {
    'CIFAR10': r'Preprocess/data/pytorch/CIFAR10',
    'CIFAR100': r'Preprocess/data/pytorch/CIFAR100',
    'ImageNet': r'/home/sanket/Undergraduate_Research_Project/ANN_SNN-20241010T153243Z-001/ANN_SNN/ANN_SNN_QCFS/Preprocess/data/pytorch/imagenet/ImageNet'
}
...
def GetImageNet(batchsize):
    ...
    train_dataloader =DataLoader(train_data, batch_size=batchsize, shuffle=False, num_workers=4, pin_memory=True)
